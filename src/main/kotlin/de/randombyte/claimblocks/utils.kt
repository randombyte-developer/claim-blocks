...
internal operator fun Vector3i.rangeTo(that: Vector3i): Vector3iRange {
    return Vector3iRange(this, that)
}

/**
 * Needed for iterating over all blocks between [start] and [endInclusive].
 */
internal class Vector3iRange(override val start: Vector3i, override val endInclusive: Vector3i) : ClosedRange<Vector3i>, Iterable<Vector3i> {
